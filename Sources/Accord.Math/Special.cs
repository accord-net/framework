...
namespace Accord.Math
{
    ...
    {
        private static readonly double[] erfcPCoef = {
        ...
        private static readonly double[] erfcQCoef = {
        ...
        private static readonly double[] erfcRCoef = {
        ...
        private static readonly double[] erfcSCoef = {
        ...
        private static readonly double[] erfTCoef = {
        ...
        private static readonly double[] erfUCoef = {
        ...
        public static double Erfc(double value)
        {
            ...
            if (x < 8.0)
            {
                p = Polevl(x, erfcPCoef, 8);
                q = P1evl(x, erfcQCoef, 8);
            }
            else
            {
                p = Polevl(x, erfcRCoef, 5);
                q = P1evl(x, erfcSCoef, 6);
            }
        ...
        public static double Erf(double x)
        {
            ...
            z = x * x;
            y = x * Polevl(z, erfTCoef, 4) / P1evl(z, erfUCoef, 5);
