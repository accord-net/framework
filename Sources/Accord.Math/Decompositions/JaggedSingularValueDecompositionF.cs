...
namespace Accord.Math.Decompositions
{
    ...
    ///   <see cref="JaggedSingularValueDecompositionF(Single[][], bool, bool, bool)">
    ...
    public sealed class JaggedSingularValueDecompositionF : ICloneable, ISolverArrayDecomposition<Single>
    {
           ...
           bool computeLeftSingularVectors, bool computeRightSingularVectors, bool autoTranspose, bool inPlace)
        {
            ...
            int nu = System.Math.Max(m, n);
            int ni = System.Math.Max(m + 1, n);
            s = new Single[ni];
            u = new Single[m][];
        ...
        public object Clone()
        {
            ...
            if (v != null) svd.v = (Single[][])u.MemberwiseClone();
