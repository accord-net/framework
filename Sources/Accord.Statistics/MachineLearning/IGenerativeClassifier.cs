...
namespace Accord.MachineLearning
{
    ...
    /// 
    public interface IGenerativeClassifier<TInput, TOutput> : IClassifier<TInput, TOutput>
    {
        /// <summary>
    ...
    /// <typeparam name="TInput">The data type for the input data. Default is double[].</typeparam>
    /// 
    public interface IGenerativeClassifier<TInput> : IClassifier<TInput>, IGenerativeClassifier<TInput, double>
    {
    }
    ...
    /// </summary>
    /// 
    public interface IGenerativeClassifier : IClassifier, IGenerativeClassifier<double[]>
    {
    }
}
