...
namespace Accord.Controls.Cyotek.Demo
{
  ...
  internal class ImageBoxEx : ImageBox
  {
    ...
    /// <summary>
    ///   Raises the <see cref="Demo.PanStart" /> event.
    /// </summary>
    /// <param name="e">
    ...
    /// <summary>
    ///   Raises the <see cref="Demo.Selecting" /> event.
    /// </summary>
    /// <param name="e">
    ...
    /// <summary>
    ///   Raises the <see cref="Demo.SelectionRegionChanged" /> event.
    /// </summary>
    /// <param name="e">
    ///   The <see cref="System.EventArgs" /> instance containing the event data.
    /// </param>
    ...
    /// <summary>
    ///   Raises the <see cref="Demo.ZoomChanged" /> event.
    /// </summary>
    /// <param name="e">
    ///   The <see cref="System.EventArgs" /> instance containing the event data.
    /// </param>
