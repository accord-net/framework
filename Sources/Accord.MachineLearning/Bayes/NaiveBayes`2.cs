...
namespace Accord.MachineLearning.Bayes
{
                              ...
                              IUnivariateDistribution
    {
        ...
        public NaiveBayes(int classes, int inputs, TDistribution initial)
            : base(classes, inputs, () => 
                new Independent<TDistribution, TInput>(inputs, 
                    (TDistribution)initial.Clone()))
        {
        }
        ...
        public NaiveBayes(int classes, int inputs, TDistribution[] initial)
            : base(classes, inputs, () => 
                new Independent<TDistribution, TInput>(inputs, (j) =>
                    (TDistribution)initial[j].Clone()))
        {
        } 
        ...
        /// 
        public NaiveBayes(int classes, int inputs, TDistribution[][] initial)
            : base(classes, inputs, (i) =>
                new Independent<TDistribution, TInput>(inputs, (j) => 
                    (TDistribution)initial[i][j].Clone()))
        {
        } 
