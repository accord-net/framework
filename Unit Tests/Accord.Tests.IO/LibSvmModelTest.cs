    ...
    public class LibSvmModelTest
    {
        ...
        public void ReadLinearMachineTest()
        {
            MemoryStream file = new MemoryStream(
              Encoding.Default.GetBytes(Accord.Tests.IO.Properties.Resources.L1R_LR_a9a2_txt));
        ...
        public void WriteLinearMachineTest()
        {
            ...
            string[] expected = Resources.L1R_LR_a9a2_txt
                .Split(new[] { Environment.NewLine }, StringSplitOptions.None);
        ...
        {
            MemoryStream file = new MemoryStream(
              Encoding.Default.GetBytes(Resources.L1R_LR_a9a2_txt));
