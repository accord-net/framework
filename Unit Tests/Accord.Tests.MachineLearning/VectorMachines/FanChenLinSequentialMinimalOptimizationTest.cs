...
namespace Accord.Tests.MachineLearning
{
    ...
    [TestFixture]
    public class FanChenLinSequentialMinimalOptimizationTest
    {
        ...
        public void LearnTest()
        {
            ...
            learn.Strategy = SelectionStrategy.SecondOrder;
        ...
        public void weight_test_homogeneous_linear_kernel()
        {
...

            {
                ...
                Assert.AreEqual(-1.3107402300323954, machine.SupportVectors[0][0], 1e-3);
                Assert.AreEqual(-0.5779471529948812, machine.SupportVectors[0][1], 1e-3);
                Assert.AreEqual(-0.53366022455811646, machine.Threshold, 1e-3);
                for (int i = 0; i < actual.Length; i++)
                {
                    int expected = actual[i];
        ...
        public void ComplexityHeuristicTest()
        {
            ...
            smo1.Strategy = SelectionStrategy.SecondOrder;
            ...
            smo2.Strategy = SelectionStrategy.SecondOrder;
        ...
        public void UseClassProportionsTest()
        {
            ...
            Assert.AreEqual(22, machine.SupportVectors.Length);
        ...
        public void WeightRatioTest()
        {
...

            {
                ...
                Assert.AreEqual(265.78327637381551, ((Gaussian)machine.Kernel).Sigma);
                Assert.AreEqual(38, machine.SupportVectors.Length);
...

            {
                ...
                Assert.AreEqual(0.2857142857142857, error);
                Assert.AreEqual(265.78327637381551, ((Gaussian)machine.Kernel).Sigma);
                Assert.AreEqual(23, machine.SupportVectors.Length);
                ...
                Assert.AreEqual(0, matrix.FalsePositives); // has more importance
                Assert.AreEqual(0, matrix.TruePositives);
                Assert.AreEqual(30, matrix.TrueNegatives); // has more importance

                Assert.AreEqual(0, matrix.Sensitivity);
                Assert.AreEqual(1, matrix.Specificity);

                Assert.AreEqual(0, matrix.FScore);
                Assert.AreEqual(0, matrix.MatthewsCorrelationCoefficient);
            }
        }
        ...
        public void FixedWeightsTest()
        {
            ...
            var str = machine.SupportVectors.ToCSharp();
        ...
        public void TransformTest()
        {
...

            {
                ...
                a.Strategy = SelectionStrategy.SecondOrder;
...

            {
                ...
                b.Strategy = SelectionStrategy.SecondOrder;
